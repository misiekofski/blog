---
title: "Moved from Wordpress to Gatsby"
date: 2022-08-09
slug: "/moved-from-wordpress-to-gatsby"
---

First post to move from Wordpres to Gatsby. The rest of the content will be added here soon.
For now i'll just add some code to keep the examples with me.

import SpotifyPlayer from "./SpotifyPlayer";


Take a while and listen a quality undeground hip-hop from Wrocław/Poland:

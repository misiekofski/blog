...
<div sx={{ mt: 4, mb: 4 }}>
  <h3>Send your question and contact info</h3>
  <iframe
    src="https://docs.google.com/forms/d/e/1FAIpQLSejF0CmWartoQ2_L1Hfnn48TxIbCHwerXnkDwKi0sccuSHvdg/viewform?embedded=true"
    width="100%"
    height="600"
    frameBorder="0"
    marginHeight="0"
    marginWidth="0"
    style={{ borderRadius: '8px', border: '1px solid #eee', background: 'white' }}
    title="Contact Form"
    allowFullScreen
  >Loading…</iframe>
</div>